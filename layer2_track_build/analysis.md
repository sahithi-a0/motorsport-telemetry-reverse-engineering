...
The speed heatmap layered onto the map does a lot of the explaining for you. The red zones are the two straights where the car reaches 193 km/h. The green and blue zones are the corners — and just by watching where the colour shifts, you can visually pick out every braking zone on the circuit without ever knowing its name. It's a clean, honest representation of where the lap time lives.
________________________________________
Plot 2 — Elevation Profile

Best lap distance comes out at 1,712 metres. That's a short circuit by any standard — your typical club track runs somewhere between 2 and 4 kilometres. This one is compact and tight, and that matters because there's nowhere to recover time if you make a mistake.
