...
CSV_PATH       = r'Driver 5  Qualifying 1.csv'
...
fig1.suptitle('Driver 5 · Qualifying · Best Lap L8  —  Plot 1: Driver Inputs Trace',
              color='white', fontsize=12)
...
fig2.suptitle('Driver 5 · Qualifying · Best Lap L8  —  Plot 2: Trail Braking Gate',
              color='white', fontsize=12)
...
fig3.suptitle('Driver 5 · Qualifying · Best Lap L8  —  Plot 3: Throttle Derivative',
              color='white', fontsize=12)
...
fig4.suptitle('Driver 5 · Qualifying · Best Lap L8  —  Plot 4: GG Diagram',
              color='white', fontsize=12)
...
fig5.suptitle('Driver 5 · Qualifying · Best Lap L8  —  Plot 5: Steering Derivative',
              color='white', fontsize=12)
...
fig6.suptitle('Driver 5 · Qualifying · Best Lap L8  —  Plot 6: Brake Pressure Delta',
              color='white', fontsize=12)
...
fig7.suptitle('Driver 5 · Qualifying · Best Lap L8  —  Plot 7: Wheel Slip Ratio',
              color='white', fontsize=12)
fig7.canvas.manager.set_window_title('Plot 8 — Wheel Slip')

gs8 = gridspec.GridSpec(2, 2, figure=fig7, width_ratios=[5, 1],
                         hspace=0.3, wspace=0.05,
                         top=0.90, bottom=0.08, left=0.06, right=0.97)
...
ax8b = fig7.add_subplot(gs8[1, 0], sharex=ax8a)
